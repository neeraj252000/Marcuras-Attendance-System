...
def Decode_Window():
    ...
    decode_window.configure(background='#34A853')
    ...
    def Decode_Data():
        ...
        entered_key  = delimeter_entry1.get()
        ...
        #     tkinter.messagebox.showinfo("Wrong Key", "Keys do not match")
        #     return
            ...
            for pixel in range(0,img2.shape[1]):
                ...
                if data_decoded_count%8 == 0 and char_set == 1:
                    ...
                    if binary_decoded_string != "":
                        ...
                        char_set = 0
                        if char_ascii<32 or char_ascii>127 or character==delimeter :
                            flag = 1
                            char_set = 0
                            break
                        else:
    ...
    image_label = Label(decode_window, text="Stego Object: ", bg='#34A853',
    ...
    delimeter_label1 = Label(decode_window, text="Enter Delimiter (Key): ", bg='#34A853',
                   fg='#FFFFFF', font=("Alegreya Sans Bold", 15))
